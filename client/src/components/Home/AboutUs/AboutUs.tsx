      ...
      <div className="home-container about-grid">
        ...
        <div className="about-text">
          ...
          <div className="about-copy">
            <p>
              We&apos;re a small team that kept juggling separate tools to shorten a link, build a bio page
              for a profile, and generate a QR code for print. That meant three logins, three dashboards, and
              no shared view of what any of it was doing.
            </p>
            <p>
